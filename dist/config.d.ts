...
export declare const configSingletonGetter: (params: DeepPartial<NextConfig> | undefined, genId: () => string) => Promise<(req: Auth0Request | Auth0RequestCookies) => Promise<NextConfig>>;
