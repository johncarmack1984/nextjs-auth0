...
function fromTokenEndpointResponse(tokenEndpointResponse, config) {
    ...
    const { id_token, access_token, scope, expires_in, /* expires_at, */ refresh_token } = tokenEndpointResponse, remainder = tslib_1.__rest(tokenEndpointResponse, ["id_token", "access_token", "scope", "expires_in", "refresh_token"]);
